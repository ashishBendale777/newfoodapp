    ...
    <div>
      ...
      <Container className='regcontainer w-50 '>
        <Form>
          ...
          <Form.Group className='mt-3'>
            <Form.Control onChange={(e) => setUserEmail(e.target.value)} type="Text" placeholder='Enter Email' />
          </Form.Group>

          <Form.Group className='mt-3'>
            <Form.Control onChange={(e) => setUserMobile(e.target.value)} type="Text" placeholder='Enter Mobile' />
          </Form.Group>

          <Form.Group className='mt-3'>
            <Form.Control onChange={(e) => setUserPassword(e.target.value)} type="Password" placeholder='Enter Password' />
          </Form.Group>

          <Button onClick={() => registerUser()} className='mt-3 w-100'>Register</Button>
          <Link to="/login">Already Regi Login</Link>
